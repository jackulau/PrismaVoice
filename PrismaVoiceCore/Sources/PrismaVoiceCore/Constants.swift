...
/// Central repository for timing thresholds and magic numbers used throughout PrismaVoiceCore.
///
...
public enum PrismaVoiceCoreConstants {
    ...
    ///
    /// **Used in:**
    /// - `PrismaVoiceSettings`: Default value for user preference
    ...
    ///
    /// **Used in:**
    /// - `PrismaVoiceSettings`: Default sound effects volume
