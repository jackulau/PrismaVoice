...
public struct RecordingDecisionEngine {
    ...
    /// See `PrismaVoiceCoreConstants.modifierOnlyMinimumDuration` for rationale.
    public static let modifierOnlyMinimumDuration: TimeInterval = PrismaVoiceCoreConstants.modifierOnlyMinimumDuration
