...
private let pasteboardLogger = PrismaVoiceLog.pasteboard
...
struct PasteboardClientLive {
    ...
    func paste(text: String) async {
        if prismaVoiceSettings.useClipboardPaste {
    ...
    func pasteWithClipboard(_ text: String) async {
        ...
        if !prismaVoiceSettings.copyToClipboard && pasteSucceeded {
        ...
        if !pasteSucceeded && !prismaVoiceSettings.copyToClipboard {
